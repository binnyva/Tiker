...
$tasks = $sql->getAll("SELECT Task.id,Task.name,Duration.from_time,Duration.to_time "
...
foreach($tasks as $task) {
	...
	if($minute_difference < 3) continue; //Too small as task to list(or its a accidental click)
